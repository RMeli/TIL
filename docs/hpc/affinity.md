...
The CPU mask is also available in the environment variable `SLURM_CPU_BIND_LIST` (or `SLURM_CPU_BIND`).

??? example "`SLURM_CPU_BIND_LIST`"

    ```console
    $ srun -N 1 -n 4 -c 64 -p debug printenv | grep SLURM_CPU_BIND_LIST
    SLURM_CPU_BIND_LIST=0x00000000000000000000000000000000000000000000000000000000FFFFFFFFFFFFFFFF,0x00000000000000000000000000000000000000FFFFFFFFFFFFFFFF000000000000000000,0x00000000000000000000FFFFFFFFFFFFFFFF000000000000000000000000000000000000,0x00FFFFFFFFFFFFFFFF000000000000000000000000000000000000000000000000000000
    SLURM_CPU_BIND_LIST=0x00000000000000000000000000000000000000000000000000000000FFFFFFFFFFFFFFFF,0x00000000000000000000000000000000000000FFFFFFFFFFFFFFFF000000000000000000,0x00000000000000000000FFFFFFFFFFFFFFFF000000000000000000000000000000000000,0x00FFFFFFFFFFFFFFFF000000000000000000000000000000000000000000000000000000
    SLURM_CPU_BIND_LIST=0x00000000000000000000000000000000000000000000000000000000FFFFFFFFFFFFFFFF,0x00000000000000000000000000000000000000FFFFFFFFFFFFFFFF000000000000000000,0x00000000000000000000FFFFFFFFFFFFFFFF000000000000000000000000000000000000,0x00FFFFFFFFFFFFFFFF000000000000000000000000000000000000000000000000000000
    SLURM_CPU_BIND_LIST=0x00000000000000000000000000000000000000000000000000000000FFFFFFFFFFFFFFFF,0x00000000000000000000000000000000000000FFFFFFFFFFFFFFFF000000000000000000,0x00000000000000000000FFFFFFFFFFFFFFFF000000000000000000000000000000000000,0x00FFFFFFFFFFFFFFFF000000000000000000000000000000000000000000000000000000
    ```
